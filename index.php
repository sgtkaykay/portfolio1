          ...
          <li>
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                <a href="index.php?page=svg6-1">Learning Task 6.1</a><br>
                <a href="index.php?page=svg6-2">Learning Task 6.2</a><br>
                <a href="index.php?page=svgcle">Culminating Learning Evidence</a>
              </div>
            </div>
          </li>
